            ...
            <div className="container">
              <div className="cs_footer_top_in">
                ...
                <div className="cs_footer_logo wow zoomIn" data-wow-duration="0.9s" data-wow-delay="0.25s">
                  <Link href="/">
                    Hardware and Instuments Centre
                  </Link> 
                  </div> 
                <div className="cs_footer_contact_card">
                  ...
                  <div>
                    <p className="cs_white_color cs_fs_14 mb-0">Contact Us</p>
                    <h3 className="mb-0 cs_fs_24 cs_semibold cs_white_color">+91 98480 41905</h3>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="cs_footer_col">
                  <div className="cs_footer_widget">
                    ...
                    {categories.map((item, i) => ( 
                      <li key={i}><Link href={`/products?categoryId=${item.id}`}>{item.name} </Link></li>
                    ))}
                    </ul>
                  </div>
                </div>
          ...
          <div className="cs_footer_bottom cs_accent_bg cs_white_color">
            <div className="container">
              <div className="cs_footer_bottom_in">
                <div className="cs_footer_copyright">Copyright@ {new Date().getFullYear()} <Link href="/">HIC</Link>. All Rights Reserved.</div>
                <ul className="cs_footer_menu cs_mp_0">
                  <li><Link href="https://alaqmar.dev">Designed and Developed by The Web Sensei</Link></li>
                </ul>
              </div>
            </div>
          </div>
