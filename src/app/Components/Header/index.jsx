...
export default function Header({ variant, products, categories }) {
          ...
          <div className="cs_top_header_in">
            <div className="cs_top_header_left">
              <ul className="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                <li>
                Welcome to Hardware and Instruments Centre
                </li>
              </ul>
            </div>
            ...
            <div className="cs_main_header_left">
              ...
              <div className="cs_main_header_center">
                <div className="cs_nav cs_primary_font fw-medium">
                  ...
                  <Nav setMobileToggle={setMobileToggle} products={products} categories={categories} />
                </div>
            </div>
