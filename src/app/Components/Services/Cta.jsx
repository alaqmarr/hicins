        ...
        <div className="container">
          <div className="cs_cta_in">
            <div className="cs_section_heading cs_style_1">
              ...
              <h2 className="cs_section_title cs_white_color cs_fs_48 cs_semibold mb-0">Get High Quality <br/>Products</h2>
            </div>
            <Link href="tel:+919848041905" className="cs_btn cs_style_1 cs_color_1">
              <span>Call Us</span>
